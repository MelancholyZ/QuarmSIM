...
public class Controller {
    ...
    private String primary = "none", secondary = "none", ranged = "none", specialAttack = "none";
    ...
    public Controller(FileHandling fh) {
        ...
        setDiscipline(1065); //Fellstrike = Bestialrage = Innerflame = Duelist = 1059, Trueshot = 1067, Holyforge = 1065
        setAttackLevels();
        setFullCombatText(true);
        setReportToConsole(true);
        setWindOfTash(true);
        setMalo(true);
        fh.clearFile("resources/ParseOutput");
        // setCustomAC(i);
        // setCustomResists(i);
        ...
        setWeaponsAndSpecial("Dathor Great Hammer", "none", "none", "none");
        ...
        //flurry 15% at r3 and 10% chance after the 15% to double flurry, berserk
        setBerserkAndAA(0, 75, 3, 3, 0, false);
        ...
        for (long i = 0; i < millisecondsToParse; i++) {
            ...
            if (Discipline.disciplineUseLevel(discipline) != 0) {
                if (Discipline.getReuseTimer() == 0) {
                    ...
                    System.out.println("[" + simple.format(result) + "] " + String_ID.discStartFlavorText(discipline));
                    discStartTimer = i;
                }

                if (discStartTimer + Discipline.getAbilityTimer() == i) {
                    System.out.println("[" + simple.format(result) + "] " + String_ID.discEndFlavorText(discipline));
    ...
    private static void primarySwing(FileHandling fh, CombatRound crMH, String mob, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", pd);
        }
        if (reportToConsole) {
            System.out.print(pd);
        }
    ...
    private static void primaryDot(FileHandling fh, String mob, String procName, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", pdt);
        }
        if (reportToConsole) {
    ...
    private static void secondarySwing(FileHandling fh, CombatRound crOH, String mob, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", sd);
        }
        if (reportToConsole) {
            System.out.print(sd);
        }
    ...
    private static void secondaryDot(FileHandling fh, String mob, String procName, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", sdt);
        }
        if (reportToConsole) {
    ...
    private static void specialAttack(FileHandling fh, CombatRound crSp, String mob, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", spa);
        }
        if (reportToConsole) {
    ...
    private static void rangedAttack(FileHandling fh, CombatRound crRng, String mob, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", ra);
        }
        System.out.print(ra);
    }
    /**
    ...
    private static void rangedProc(FileHandling fh, Weapon ranged, String mob, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", rd);
        }
        if (reportToConsole) {
            System.out.print(rd);
        }
    ...
    private static void rangedDot(FileHandling fh, String mob, String procName, String timestamp) {
        ...
        if (fullCombatTextToFile) {
            fh.writeToFile("resources/ParseOutput", rdt);
        }
        if (reportToConsole) {
     ...
     */
    public void setWeaponsAndSpecial(String primary, String secondary, String ranged, String specialAttack) {
