...
//            attacker->aabonuses.HitChanceEffect[EQ::skills::HIGHEST_SKILL + 1];
        // Hardcoded eagle eye TODO change to boolean flag in controller
        if(skillInUse.equals("Archery")) {
            toHitPct = 40;
        } else if (Discipline.getActiveDisc() == 1067) { // Trueshot = 1067
            toHitPct = 33;
        } else if (Discipline.getActiveDisc() == 1049) { // Precision = 1049
            toHitPct = 50;
        } else if (Discipline.getActiveDisc() == 1051) { // Evasive = 1051
            toHitPct = -33;
        } else if (Discipline.getActiveDisc() == 1061) { // Charge = 1061
            toHitPct = 10000;
        }

        // TODO: Avoidance in Disciplines for tank parsing
        // Charge disc = 10000% chance to hit
        // Precision disc = 50% chance to hit, 33% decrease in avoidance
        // Evasive disc - 50% avoidance, 33% decrease in accuracy
        // 10000% avoidance discs Voiddance, Fortitude
